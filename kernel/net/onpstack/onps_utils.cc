...
#include "ip/ip_frame.hh"
#define STDLIB 1	  // 启用 stdlib 函数
#define STDIO 1		  // 启用 stdio 函数
#include "klib.hh"	  // 添加内核库函数支持
#include "printer.hh" // 添加内核打印函数支持
...
USHORT ascii_to_hex_16(const CHAR *pszAscii)
{
	...
	for (i = 0; i < (INT)strlen(pszAscii); i++)
