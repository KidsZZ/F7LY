...
static inline uint64_t reorder64(uint64_t n) {
    return ((n & 0xff) << 56) | ((n & 0xff00) << 40) | ((n & 0xff0000) << 24) | ((n & 0xff000000LL) << 8) |
           ((n & 0xff00000000LL) >> 8) | ((n & 0xff0000000000LL) >> 24) | ((n & 0xff000000000000LL) >> 40) |
...
static inline uint16_t reorder16(uint16_t n) { return ((n & 0xff) << 8) | ((n & 0xff00) >> 8); }
