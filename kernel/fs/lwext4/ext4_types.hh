...
#define EXT2_SUPPORTED_FRO_COM (EXT4_FRO_COM_SPARSE_SUPER | EXT4_FRO_COM_LARGE_FILE)
...
#define EXT3_SUPPORTED_FRO_COM (EXT4_FRO_COM_SPARSE_SUPER | EXT4_FRO_COM_LARGE_FILE)
...
#define EXT4_SUPPORTED_FINCOM                                                                                          \
    (EXT4_FINCOM_FILETYPE | EXT4_FINCOM_META_BG | EXT4_FINCOM_EXTENTS | EXT4_FINCOM_FLEX_BG | EXT4_FINCOM_64BIT)

#define EXT4_SUPPORTED_FRO_COM                                                                                         \
    (EXT4_FRO_COM_SPARSE_SUPER | EXT4_FRO_COM_METADATA_CSUM | EXT4_FRO_COM_LARGE_FILE | EXT4_FRO_COM_GDT_CSUM |        \
     EXT4_FRO_COM_DIR_NLINK | EXT4_FRO_COM_EXTRA_ISIZE | EXT4_FRO_COM_HUGE_FILE)
...
#define EXT4_DIRENT_TAIL(block, blocksize)                                                                             \
    ((struct ext4_dir_entry_tail *) (((char *) (block)) + ((blocksize) - sizeof(struct ext4_dir_entry_tail))))
...
#define JBD_HAS_COMPAT_FEATURE(jsb, mask)                                                                              \
    ((jsb)->header.blocktype >= to_be32(2) && ((jsb)->feature_compat & to_be32((mask))))
#define JBD_HAS_RO_COMPAT_FEATURE(jsb, mask)                                                                           \
    ((jsb)->header.blocktype >= to_be32(2) && ((jsb)->feature_ro_compat & to_be32((mask))))
#define JBD_HAS_INCOMPAT_FEATURE(jsb, mask)                                                                            \
    ((jsb)->header.blocktype >= to_be32(2) && ((jsb)->feature_incompat & to_be32((mask))))
...
#define JBD_KNOWN_INCOMPAT_FEATURES                                                                                    \
    (JBD_FEATURE_INCOMPAT_REVOKE | JBD_FEATURE_INCOMPAT_ASYNC_COMMIT | JBD_FEATURE_INCOMPAT_64BIT |                    \
     JBD_FEATURE_INCOMPAT_CSUM_V2 | JBD_FEATURE_INCOMPAT_CSUM_V3)
